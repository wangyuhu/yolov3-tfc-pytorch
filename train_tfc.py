...
def train(
    ...
    for epoch in range(epochs):
        ...
        for i, (imgs, targets) in enumerate(dataloader):
            ...
            info = {'total loss':rloss['loss']}
            logger.add_scalars("total loss",info,(epoch-1)*15000+i)
            t0 = time.time()
            print(s)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-config', type=str, default='cfg/tfc.data', help='path to data config file')
    parser.add_argument('--cfg', type=str, default='cfg/yolov3-tfc.cfg', help='cfg file path')
